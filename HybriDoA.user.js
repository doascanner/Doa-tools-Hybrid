...
//
// @match         *://*.castle.rykaiju.com/platforms/kabam/*
// @match         *://*.castle.rykaiju.com/platforms/*/game*
...
Réactiver le script et changer les url => OK
Remettre a jour les fonctions et requetes
...
var Ajax = {
   ...
   serialize: function serialize( object ){
      ...
      for (var prop in object) {
         chunks.push(encodeURIComponent(prop) + "=" + encodeURIComponent(object[prop]));
      }
      return chunks.join("&");
   },
